...
const PROJECT_SUBJECT = "Blog Draft Team";
const DOMAIN_SUMMARY = "{'topic': 'Content Creation', 'subtopics': ['Blog Post Drafting', 'Collaboration', 'AI-assisted Writing'], 'key_terms': ['natural language processing', 'multi-agent systems', 'content creation']}";
const USER_PERSONA = "Alex: Content Creator";
const STARTER_QUESTIONS = ["What is the topic of the blog post?", "What are the keywords and tone for the blog post?", "What is the desired length and format of the blog post?"];
